...
module.exports = async function (deployer) {
  ...
  let airDrop = await RecordAirDropDelegate.at((await CommonProxy.deployed()).address);
  
  await airDrop.initialize(deployerAddr, robot);
  ...
  console.log('record-air-drop:', airDrop.address);
